            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="code">
                        <Input type="text" v-model="searchForm.code" placeholder="区域编码" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="区域名称" clearable style="width: 120px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getSupermarketAreaList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
