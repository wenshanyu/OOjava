            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="code">
                        <Input type="text" v-model="searchForm.code" placeholder="货架编码" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="货架名称" clearable style="width: 120px" />
                    </Form-item>
                    ...
                    <Form-item label="" prop="status">
                        <Select v-model="searchForm.areaId" clearable placeholder="超市区域..." style="width:120px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getSupermarketShelvesList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
