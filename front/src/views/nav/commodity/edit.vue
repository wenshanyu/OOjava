        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <Row :gutter="16">
                ...
                <FormItem label="商品编码" prop="code">
                    <Input v-model="form.code" readonly show-word-limit maxlength="240" placeholder="请输入商品的编码..." style="width:100%" />
                </FormItem>
                </Col>
                <Col span="12">
                ...
                <Col span="12">
                <FormItem label="商品大类" prop="bigType">
                    <Input v-model="form.bigType" readonly show-word-limit maxlength="240" placeholder="请输入商品的大类..." style="width:100%" />
                </FormItem>
                </Col>
                <Col span="12">
                ...
                <FormItem label="所属区域" prop="area">
                    <Input v-model="form.area" readonly show-word-limit maxlength="240" placeholder="请输入商品的所属区域..." style="width:100%" />
                </FormItem>
                </Col>
                <Col span="12">
