        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="code">
                        <Input type="text" v-model="searchForm.code" placeholder="商品编码" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="商品名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="typeId">
                        <Select v-model="searchForm.typeId" placeholder="商品类型" clearable style="width: 120px">
                            <Option v-for="(item,index) in typeList" :key="index" :value="item.id">{{item.title}}</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="shelvesId">
                        <Select v-model="searchForm.shelvesId" placeholder="所属货架" clearable style="width: 120px">
        ...
        return {
            ...
            columns: [
                    ...
                    render: (h, params) => {
                        if (params.row.image != undefined && params.row.image != "") {
                            return h("img", {
                                ...
                                on: {
                                    click: () => {
                                        window.open(params.row.image + "?preview=true")
                                    },
                                },
                            });
                        } else {
                ...
                },
                {
                    ...
                    sortable: false,
                    render: (h, params) => {
                        if (params.row.prove != undefined && params.row.prove != "") {
                            return h("img", {
                                attrs: {
                                    src: require("@/assets/file.png")
                                },
                                ...
                                on: {
                                    click: () => {
                                        window.open(params.row.prove + "?preview=true")
                                    },
                                },
                            });
                        } else {
